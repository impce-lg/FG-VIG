...
class TestVIO {
 public:
  TestVIO(const Configuration *pConfig,
          const double FirstNavStateIMUTime, const string &ConfigFile);
  ...
  void RunVIO(const Configuration *pConfig, const IMU *pIMU,
 ...
 private:
  ...
  gtsam::Values mNewInitialValues_, mFLResultValues_, mResultValues_;
};
